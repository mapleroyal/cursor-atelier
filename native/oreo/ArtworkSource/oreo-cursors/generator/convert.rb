...
# Modified 2026-07-26 by mapleroyal: normalized generated index.theme
# attribution so it does not embed a local invocation path.
...
INDEX_THEME = proc do |x|
	<<~EOF
		...
		# Modified 2026-07-26 by mapleroyal: normalized generator attribution.
		Comment=design by varlesh | colour generation by Sourav Goswami
	EOF
end
